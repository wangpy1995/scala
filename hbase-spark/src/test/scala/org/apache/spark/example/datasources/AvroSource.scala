...
package org.apache.spark.example.datasources
...
object AvroSource {
  ...
  def main(args: Array[String]) {
    val sparkConf = new SparkConf().setAppName("AvroSourceExample").setMaster("local[*]")
