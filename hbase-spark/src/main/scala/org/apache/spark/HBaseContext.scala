...
import org.apache.hadoop.hbase.regionserver.{BloomType, HStore, StoreFile, StoreFileWriter}
...
import org.apache.spark.HBaseRDDFunctions._
...
class HBaseContext(@transient sc: SparkContext,
  ...
  def bulkLoad[T](rdd: RDD[T],
                  ...
                  java.util.Map[Array[Byte], FamilyHFileWriteOptions] =
  ...
  Unit = {
    ...
    val familyHFileWriteOptionsMapInternal =
      new java.util.HashMap[ByteArrayWrapper, FamilyHFileWriteOptions]
  ...
  private def getNewHFileWriter(family: Array[Byte], conf: Configuration,
                                ...
                                familydir: Path,
                                familyHFileWriteOptionsMapInternal:
                                java.util.HashMap[ByteArrayWrapper, FamilyHFileWriteOptions],
