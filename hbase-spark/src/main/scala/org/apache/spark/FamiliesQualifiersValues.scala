...
class FamiliesQualifiersValues extends Serializable {
  ...
  val familyMap = new java.util.TreeMap[ByteArrayWrapper,
    java.util.TreeMap[ByteArrayWrapper, Array[Byte]]]()
  ...
  def +=(family: Array[Byte], qualifier: Array[Byte], value: Array[Byte]): Unit = {
    ...
    if (qualifierValues == null) {
      qualifierValues = new java.util.TreeMap[ByteArrayWrapper, Array[Byte]]()
